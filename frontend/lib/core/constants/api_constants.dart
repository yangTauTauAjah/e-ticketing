class ApiConstants {
  ...
  static const String forgotPasswordRequest = "$baseUrl/auth/password-reset/request";
  static const String forgotPasswordConfirm = "$baseUrl/auth/password-reset/confirm";
  ...
  static const String passwordResetRequest = "$baseUrl/users/password-reset/request";
